 ...
 */
public class GridviewApater2 extends BaseAdapter {
    ...
    public GridviewApater2(Context context, List<WLEntity> dataList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (i < dataList.size()) {
            Bitmap bitmap = dataList.get(i).getBitmap();
            ...
            holder.icon_img.setImageResource(R.drawable.sc);
            Log.i("kkk", "sssss");
        }
